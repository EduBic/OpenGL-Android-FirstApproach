...
public class Sprite {
    ...
    private static final float[] _quadTextureCoordinates = {
            0.0f, 1.0f,     // bottom left
            1.0f, 1.0f,     // bottom right
            0.0f, 0.0f,     // top left (as geometry choice)
            1.0f, 0.0f,     // top right
    };
    ...
    private static int _textureUniformLocation = -1;
...
//    }
    ...
    public void setTexture(Bitmap texture) {
        ...
        // for change texture in GPU
        /*if (_textureName != 0) {
            int[] doomedTextures = { _textureName };
    ...
    private static void setUp() {
        ...
        String vertexShaderSource = "" +
                ...
                "    textureCoordinateInterpolated = textureCoordinate; \n" +     // this line is needed for Rendering of OpenGL
                /*"    textureCoordinateInterpolated = vec2(textureCoordinate.x + textureTranslate.x, textureCoordinate.y + textureTranslate.y); \n" + // move in your texture bitmap */
                "} \n" +
                "\n";
        ...
        _textureUniformLocation = GLES20.glGetUniformLocation(_program, "textureUnit");
        ...
        ByteBuffer quadTextureCoordinateByteBuffer = ByteBuffer.allocateDirect(_quadTextureCoordinates.length * 4);
        ...
        // set the _texture from an integer
        GLES20.glUniform1i(_textureUniformLocation, 0); // we need to do every frame??? Not in this case
    ...
    public void draw() {
        ...
        if (_textureName <= 0 && _texture != null) {    // init instance data
            // allocate _texture
            int[] textureNames = new int[1];
            textureNames[0] = -1;
            // i1: number of _texture object;
            // i2: array of _texture object id (int)
            // i3: starting index for iterate array i2
            GLES20.glGenTextures(0, textureNames, 0);
            _textureName = textureNames[0];

            GLES20.glBindTexture(GLES20.GL_TEXTURE_2D, _textureName);
            // using a util provide by android, otherwise use GLES20.glTexImage2D()
        ...
        // if for each draw we change value of uniform variable
        // the GPU move sprites here
